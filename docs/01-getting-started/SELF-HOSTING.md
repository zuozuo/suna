...
1. **Explore the System**:
   - [Hello Execution Flow](./hello-execution-flow.md) - Understand how the system works
   - [Architecture Overview](../02-core-architecture/architecture-overview.md) - Learn about the system design
   - [Tool System](../03-tool-system/tool-system-overview.md) - Explore available tools

2. **Advanced Configuration**:
   - [Authentication & Multi-Tenancy](../05-advanced-features/auth-and-multi-tenancy-architecture.md) - Set up enterprise features
   - [MCP Integration](../04-extension-systems/mcp-integration.md) - Add external tools
   - [Workflow Engine](../04-extension-systems/workflow-engine.md) - Create automation workflows
